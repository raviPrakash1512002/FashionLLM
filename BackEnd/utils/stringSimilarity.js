...
class StringSimilarity {
  ...
  // Main similarity calculation method used by DynamicSchemaDetector
  static calculateSimilarity(str1, str2) {
    if (!str1 || !str2) return 0;
    
    // Use a combination of Levenshtein and Jaccard for better accuracy
    const levenshtein = this.getLevenshteinDistance(str1, str2);
    const jaccard = this.getJaccardSimilarity(str1, str2);
